...
// Query para obtener los datos de la tabla "orden_dielectrico_m" donde id coincide con $id
$query = "SELECT * FROM orden_dielectrico_m WHERE id = $id_orden";
...
{
    $sql = "SELECT COUNT(*) AS count_items FROM orden_item_m WHERE id_orden = $id_orden ";
    ...
    if ($result->num_rows > 0) {
        ...
        $sql_update = "UPDATE orden_dielectrico_m SET items = $count WHERE id = $id_orden";
...
{
    $sql = "SELECT resultado, COUNT(*) AS count_resultado FROM orden_item_m WHERE id_orden = $id_orden GROUP BY resultado";
...
{
    $sql = "SELECT clase, COUNT(*) AS count_resultado FROM orden_item_m WHERE id_orden = $id_orden GROUP BY clase";
