...
if ($_SERVER['REQUEST_METHOD'] === 'POST' and $funcion == "agrego_orden") {
    ...
    $estado = $_POST['estado'];
    $items = $_POST['items'];
    $rs = mysqli_query($conexion, "SELECT MAX(id) AS id FROM orden_dielectrico");
    ...
    // Insertar los datos en la tabla "orden_dielectrico"
    $sql = "INSERT INTO orden_dielectrico (id,cliente, ruc, equipo, vendedor, estado, items, fecha) 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $funcion == "eliminar_orden") {
    ...
    $sql1 = "DELETE FROM orden_dielectrico WHERE id = '$id'";
    eliminarFila($conexion, $sql1);

    $sql2 = "DELETE FROM orden_item where id_orden = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' and $funcion == "agrego_items") {
    ...
    {
        $res2 = mysqli_query($conexion, "SELECT MAX(nro_orden) as max FROM orden_item where id_orden='$id_orden'");
    ...
    {
        $consulta = "INSERT INTO orden_item(id_orden,marca,clase,fecha,nro_orden,equipo,n_informe,vendedor,empresa,talla,resultado) 
    ...
    {
        $consulta = "INSERT INTO orden_item(id_orden,marca,clase,fecha,nro_orden,equipo,n_informe,vendedor,empresa,resultado) 
    ...
    {
        $consulta = "INSERT INTO orden_item(id_orden,marca,clase,fecha,nro_orden,equipo,n_informe,vendedor,empresa,resultado,talla) 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' and $funcion == "borro_items") {
    $id = $_POST['id'];
    // Realizar la lógica de eliminación de datos en la base de datos
    $sql = "DELETE FROM orden_item WHERE id = '$id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' and $funcion == "edito_items") {
    ...
    {
        $maxSerie = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT MAX(serie_guante) AS max_serie FROM orden_item"))['max_serie'];
        ...
        if ($serieColumn === "serie_edit") {
            mysqli_query($conexion, "UPDATE orden_item SET serie_guante = NULL WHERE id = '$id_item'");
        }

        $consultaUpdate = "UPDATE orden_item 
    ...
    {
        $maxSerie = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT MAX(serie_manta) AS max_serie FROM orden_item"))['max_serie'];

        $serieColumn = ($serie == $maxSerie) ? "serie_manta" : "serie_edit";

        // Actualizar la columna serie_guante a NULL si serie_edit se va a modificar
        if ($serieColumn === "serie_edit") {
            mysqli_query($conexion, "UPDATE orden_item SET serie_manta = NULL WHERE id = '$id_item'");
        }
    ...
    {
        $maxSerie = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT MAX(serie_banqueta) AS max_serie FROM orden_item"))['max_serie'];

        $serieColumn = ($serie == $maxSerie) ? "serie_banqueta" : "serie_edit";

        // Actualizar la columna serie_guante a NULL si serie_edit se va a modificar
        if ($serieColumn === "serie_edit") {
            mysqli_query($conexion, "UPDATE orden_item SET serie_banqueta = NULL WHERE id = '$id_item'");
        }
    ...
    {
        $maxSerie = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT MAX(serie_pertiga) AS max_serie FROM orden_item"))['max_serie'];

        $serieColumn = ($serie == $maxSerie) ? "serie_pertiga" : "serie_edit";

        // Actualizar la columna serie_guante a NULL si serie_edit se va a modificar
        if ($serieColumn === "serie_edit") {
            mysqli_query($conexion, "UPDATE orden_item SET serie_pertiga = NULL WHERE id = '$id_item'");
        }
    ...
    {
        $maxSerie = mysqli_fetch_assoc(mysqli_query($conexion, "SELECT MAX(serie_manga) AS max_serie FROM orden_item"))['max_serie'];

        $serieColumn = ($serie == $maxSerie) ? "serie_manga" : "serie_edit";

        // Actualizar la columna serie_guante a NULL si serie_edit se va a modificar
        if ($serieColumn === "serie_edit") {
            mysqli_query($conexion, "UPDATE orden_item SET serie_manga = NULL WHERE id = '$id_item'");
        }
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' and $funcion == "agrego_series") {
    ...
    if ($equipo == "Guantes") {
        ...
        $sql_max_serie = "SELECT MAX(serie_guante) AS max_serie FROM orden_item";
        $result_max_serie = $conexion->query($sql_max_serie);
        $max_serie = $result_max_serie->fetch_assoc()["max_serie"];

        $sql_cant_items = "SELECT items FROM orden_dielectrico WHERE id = $id_orden";
        $cant_items_result = $conexion->query($sql_cant_items);
        $cant_items = $cant_items_result->fetch_assoc()["items"];

        $query_null_ids = "SELECT id FROM orden_item WHERE id_orden = $id_orden AND serie_guante IS NULL AND serie_edit IS NULL";
        ...
        if ($resultado) {
            ...
            for ($i = 0; $i < $num_null_ids; $i++) {
                ...
                echo "ID: $id_items\n";
                $update_sql = "UPDATE orden_item SET serie_guante = $serie_actualizada WHERE id = $id_items AND serie_guante IS NULL";
    ...
    if ($equipo == "Mantas") {
        ...
        $sql_max_serie = "SELECT MAX(serie_manta) AS max_serie FROM orden_item";
        $result_max_serie = $conexion->query($sql_max_serie);
        $max_serie = $result_max_serie->fetch_assoc()["max_serie"];
        ...
        $query_null_ids = "SELECT id FROM orden_item WHERE id_orden = $id_orden AND serie_manta IS NULL AND serie_edit IS NULL";
        $resultado = mysqli_query($conexion, $query_null_ids);
        ...
        if ($resultado) {
            ...
            for ($i = 0; $i < $num_null_ids; $i++) {
                ...
                echo "Nuevo número de serie: $serie_actualizada\n";
                echo "ID: $id_items\n";
                $update_sql = "UPDATE orden_item SET serie_manta = $serie_actualizada WHERE id = $id_items AND serie_manta IS NULL";
    ...
    if ($equipo == "Banquetas") {
        ...
        $sql_max_serie = "SELECT MAX(serie_banqueta) AS max_serie FROM orden_item";
        $result_max_serie = $conexion->query($sql_max_serie);
        $max_serie = $result_max_serie->fetch_assoc()["max_serie"];
        ...
        $query_null_ids = "SELECT id FROM orden_item WHERE id_orden = $id_orden AND serie_banqueta IS NULL AND serie_edit IS NULL";
        $resultado = mysqli_query($conexion, $query_null_ids);
        ...
        if ($resultado) {
            ...
            for ($i = 0; $i < $num_null_ids; $i++) {
                ...
                echo "Nuevo número de serie: $serie_actualizada\n";
                echo "ID: $id_items\n";
                $update_sql = "UPDATE orden_item SET serie_banqueta = $serie_actualizada WHERE id = $id_items AND serie_banqueta IS NULL";
    ...
    if ($equipo == "Pertigas") {
        ...
        $sql_max_serie = "SELECT MAX(serie_pertiga) AS max_serie FROM orden_item";
        $result_max_serie = $conexion->query($sql_max_serie);
        $max_serie = $result_max_serie->fetch_assoc()["max_serie"];
        ...
        $query_null_ids = "SELECT id FROM orden_item WHERE id_orden = $id_orden AND serie_pertiga IS NULL AND serie_edit IS NULL";
        $resultado = mysqli_query($conexion, $query_null_ids);
        ...
        if ($resultado) {
            ...
            for ($i = 0; $i < $num_null_ids; $i++) {
                ...
                echo "Nuevo número de serie: $serie_actualizada\n";
                echo "ID: $id_items\n";
                $update_sql = "UPDATE orden_item SET serie_pertiga = $serie_actualizada WHERE id = $id_items AND serie_pertiga IS NULL";
    ...
    if ($equipo == "Mangas") {
        ...
        $sql_max_serie = "SELECT MAX(serie_manga) AS max_serie FROM orden_item";
        $result_max_serie = $conexion->query($sql_max_serie);
        $max_serie = $result_max_serie->fetch_assoc()["max_serie"];
        ...
        $query_null_ids = "SELECT id FROM orden_item WHERE id_orden = $id_orden AND serie_manga IS NULL AND serie_edit IS NULL";
        $resultado = mysqli_query($conexion, $query_null_ids);
        ...
        if ($resultado) {
            ...
            for ($i = 0; $i < $num_null_ids; $i++) {
                ...
                echo "Nuevo número de serie: $serie_actualizada\n";
                echo "ID: $id_items\n";
                $update_sql = "UPDATE orden_item SET serie_manga = $serie_actualizada WHERE id = $id_items AND serie_manga IS NULL";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' and $funcion == "edito_orden") {
    ...
    mysqli_query($conexion, "UPDATE orden_dielectrico SET cliente = '$cliente',ruc = '$ruc',estado = '$estado',salida = '$salida',vendedor = '$vendedor' WHERE id = '$id_orden'");
    header("Location:orden.php?id=$id_orden");
}
if ($_SERVER['REQUEST_METHOD'] == 'POST' and $funcion == "datos_informe") {
    ...
    echo $id_orden;
    echo $temperatura;
    mysqli_query($conexion, "UPDATE orden_dielectrico SET fecha_informe='$fecha_inf',humedad = '$humedad',temperatura = '$temperatura' WHERE id = '$id_orden'");
    header("Location:orden.php?id=$id_orden");
}
if ($_SERVER['REQUEST_METHOD'] == 'GET' and $funcion == "genero_pdf") {
    ...
    if ($equipo == "Guantes") {
        ...
        $serie_edit = array();
        $otro = array();
        // Consulta SQL para obtener los valores de la tabla "orden_item"
        ...
        // Consulta SQL para obtener los valores de la tabla "orden_item"
        $sql = "SELECT * FROM orden_dielectrico WHERE id = $id_orden";
        ...
        function GeneroPdf($n_informe, $marca, $clase, $serie, $f_informe, $empresa, $longitud, $valor_izq, $valor_der, $otro)
        {
            ...
            if ($otro == "Inflado") {
                ...
                6CB50/10-3 verificado con un Patrón kilovoltimetro modelo KVM-100 marca Phenix (Informes: 16135605052023 / LE-011-2023).</div>';
            }
    ...
    if ($equipo == "Pertigas") {
        ...
        // Consulta SQL para obtener los valores de la tabla "orden_dielectrico"
        $sql = "SELECT * FROM orden_dielectrico WHERE id = $id_orden";
    ...
    if ($equipo == "Mangas") {
        ...
        function GeneroPdf($n_informe, $marca, $clase, $serie, $f_informe, $empresa, $longitud, $valor_izq, $valor_der, $otro)
        {
            ...
            $tension = isset($clases[$clase]) ? $clases[$clase] : "Valor no encontrado";
            ...
            $html .= '<br><br><br><div class="row" style="font-weight: bold;">1. Datos Generales</div>';
            $html .= '<div class="row"><table>
            <tr><td>Equipo:</td><td>Manga dieléctrico</td></tr>
            <tr><td>Marca:</td><td>' . $marca . '</td></tr>
            <tr><td>Clase:</td><td>' . $clase . '</td></tr>
            <tr><td>Serie:</td><td>' . $serie . '</td></tr>
            <tr><td>Fecha de verificación:</td><td>' . $f_informe . '</td></tr>
            ...
            if ($otro == "Inflado") {
                ...
                <tr>
                    <th class="tg-uqo3">Lado</th>
                    <th class="tg-uqo3">Clase</th>
                    <th class="tg-uqo3">Tensión de Prueba (DC)</th>
                    <th class="tg-uqo3">Resultado</th>
                </tr>
                </thead>
                <tbody>
                ...
                $html .= '<div class="row">Nota: Para las pruebas de verificación dieléctrica, se utilizó un generador de alto voltaje marca Megabras modelo
                DT-70 Kv verificado con un Patrón kilovoltimetro modelo KVM-100 marca Phenix.</div>';
            }
            $html .= '<div class="row" style="font-weight: bold;">4. Condiciones Ambientales:</div>';
            $html .= '<div class="row">Temperatura ambiente: (20 ± 3) ºC / Humedad: (75 ± 5) %</div>';
            $html .= '<div class="row" style="font-weight: bold;">5. Lugar de calibración:</div>';
            ...
            $mpdf->WriteHTML($html);
            ob_clean();
            $nombre_archivo_pdf =  $n_informe . '-Manga-' . $marca . '-' . $clase . '-' . $empresa . '(M).pdf';
            $mpdf->Output(__DIR__ . '/pdfs/' . $nombre_archivo_pdf, 'F');  // Guarda el PDF en un directorio
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' and $funcion == "obs") {
}
