        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="procesar.php?funcion=agrego_items" method="post">
                    <input value="<?php echo $cliente; ?>" name="empresa">
                    <input value="<?php echo $vendedor; ?>" name="vendedor">
                    <input value="<?php echo $id_orden; ?>" name="id_orden">
                    <input value="<?php echo $equipo; ?>" name="equipo">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" name="tipo" id="">
                                            <option value="Manta dielectrica">Manta Dielectrica</option>
                                            <option value="Piso dielectrico">Piso Dielectrico</option>
                                        </select>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    <td colspan="2">
                                        <div class="input-group input-group-sm mb-3">
                                            <span class="input-group-text" id="inputGroup-sizing-sm">Fecha del Informe</span>
