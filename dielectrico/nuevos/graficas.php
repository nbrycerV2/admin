...
$sql = "SELECT MONTH(fecha) AS mes, equipo, COUNT(*) AS cantidad FROM orden_item WHERE YEAR(fecha) = $selectedYear GROUP BY MONTH(fecha), equipo ";
...
function countItemsByClassAndYear($conexion, $selectedYear, $equipo)
{
    ...
    $sql = "SELECT clase, COUNT(*) AS count_items FROM orden_item WHERE equipo = $equipo AND YEAR(fecha) = $selectedYear GROUP BY clase";
...
function countItemsByClientAndYear($conexion, $selectedYear, $equipo)
{
    ...
    // Consulta para contar los items por clase "Guantes" y año específico
    $sql = "SELECT empresa, COUNT(*) AS count_items FROM orden_item WHERE equipo = $equipo AND YEAR(fecha) = $selectedYear GROUP BY empresa ORDER BY count_items DESC";
...
function countItemsByMarcaAndYear($conexion, $selectedYear, $equipo)
{
    ...
    // Consulta para contar los items por clase "Guantes" y año específico
    $sql = "SELECT marca, COUNT(*) AS count_items FROM orden_item WHERE equipo = $equipo AND YEAR(fecha) = $selectedYear GROUP BY marca";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    <h1 class="h3 mb-0 text-gray-800">Graficas de Dielectricos Nuevos</h1>
                </nav>
                <!-- Begin Page Content -->
