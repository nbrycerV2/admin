            ...
            $("#dataTable").DataTable({
                ...
                columns: [{
                        ...
                        render: function(data, type, row) {
                            return '<a class="btn btn-primary btn-sm2" href="orden.php?IdOrdMant=' + row.IdOrdMant + '">Abrir</a> <button class="btn btn-danger btn-sm2" onclick="borrar(' + row.IdOrdMant + ')">Borrar</button>';
                        }
                    },
                    {
                        "data": "IdOrdMant"
